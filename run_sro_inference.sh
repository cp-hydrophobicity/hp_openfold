...
#SBATCH --output=../output/logs/mc_inference_logs/mc_inference_%j.out
#SBATCH --error=../output/logs/mc_inference_logs/mc_inference_%j.err
...
# Set defaults
CHECKPOINT_PATH="/gpfs/data/rsingh47/hp_protein_folding/protein_folding/output/refinement_model/p7_ph5_lr_2e-3_tri_prior/checkpoint_epoch_2.pt"
INPUT_DIR="/gpfs/data/rsingh47/hp_protein_folding/protein_folding/output/example/in"
OUTPUT_DIR="/gpfs/data/rsingh47/hp_protein_folding/protein_folding/output/multi_cycle_example/out"
SIMPLE_MODEL=false
TEMPERATURE=300.0
...
# Build command
CMD="python run_sro_inference.py --checkpoint_path $CHECKPOINT_PATH --input_path $INPUT_DIR --output_dir $OUTPUT_DIR"
